    ...
    >
        ...
        >
          {Array.from({ length: 4 }).map((_, index) => (
            ...
            >
              Réserver un Call
              <FaPhone
                className=" text-gray-500  font-bold p-0 m-0 text-center  group-hover:text-gray-700 "
                height={48}
                width={48}
              />
            </span>
      ...
      <div className="contact-links flex flex-col md:flex-row items-center justify-between w-full gap-4 md:gap-0  lg:px-60 px-12 ">
        <a
          ...
          className="text-lg text-gray-500 hover:text-gray-700 transition-all duration-300 flex items-center gap-2 font-semibold text-nowrap"
        >
